    ...
    public class NarrowphaseStressTests
    {
        ...
        public void GjkEpa_RandomConvexPairs_NoCrashes()
        {
            ...
            for (int i = 0; i < 200; i++)
            {
                ...
                ITransform ta = new Transform(new Vector3((float)rnd.NextDouble() * 5f, (float)rnd.NextDouble() * 5f, (float)rnd.NextDouble() * 5f), Quaternion.Identity);
                ITransform tb = new Transform(new Vector3((float)rnd.NextDouble() * 5f, (float)rnd.NextDouble() * 5f, (float)rnd.NextDouble() * 5f), Quaternion.Identity);
        ...
        public void CollidePrimitives_MixedPairs_NoCrashes()
        {
            ...
            for (int i = 0; i < 200; i++)
            {
                ...
                ITransform ta = new Transform(new Vector3((float)rnd.NextDouble(), (float)rnd.NextDouble(), (float)rnd.NextDouble()), Quaternion.Identity);
                ITransform tb = new Transform(new Vector3((float)rnd.NextDouble(), (float)rnd.NextDouble(), (float)rnd.NextDouble()), Quaternion.Identity);
