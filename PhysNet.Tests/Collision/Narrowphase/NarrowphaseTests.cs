...
namespace PhysNet.Tests.Collision.Narrowphase
{
    public class NarrowphaseTests
    {
        ...
        public void SphereSphere_Collides()
        {
            ...
            ITransform t1 = new Transform(new Vector3(0,0,0), Quaternion.Identity);
            ITransform t2 = new Transform(new Vector3(1.5f,0,0), Quaternion.Identity);
        ...
        public void Gjk_NoCollision_ForSeparatedBoxes()
        {
            ...
            ITransform t1 = new Transform(new Vector3(0,0,0), Quaternion.Identity);
            ITransform t2 = new Transform(new Vector3(10,0,0), Quaternion.Identity);
